...
const sectionNavButtons = document.querySelectorAll('.notes-section-nav .notes-nav-btn');
...
document.addEventListener('DOMContentLoaded', function () {
    const mainMenuItems = document.querySelectorAll('.notes-nav-item.has-submenu');
    ...
    const submenuLinks = document.querySelectorAll('.notes-nav-submenu .notes-nav-link');
